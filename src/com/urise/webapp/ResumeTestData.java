...
public class ResumeTestData {
    ...
    private static Resume getTestResume() {
        ...
        List<WorkSection.Work> workList = workSection.getWorkList();
        WorkSection.Work work = new WorkSection.Work("Java Online Projects");
        work.addDescription("10/2013 - Сейчас", "Автор проекта.", "Создание, организация и проведение Java онлайн проектов и стажировок.");
        workList.add(work);
        work = new WorkSection.Work("Wrike");
        work.addDescription("10/2014 - 01/2016", "Старший разработчик (backend)", "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO.");
        workList.add(work);
        work = new WorkSection.Work("RIT Center");
        work.addDescription("04/2012 - 10/2014", "Java архитектор", "Организация процесса разработки системы ERP для разных окружений: релизная политика, версионирование, ведение CI (Jenkins), миграция базы (кастомизация Flyway), конфигурирование системы (pgBoucer, Nginx), AAA via SSO. Архитектура БД и серверной части системы. Разработка интергационных сервисов: CMIS, BPMN2, 1C (WebServices), сервисов общего назначения (почта, экспорт в pdf, doc, html). Интеграция Alfresco JLAN для online редактирование из браузера документов MS Office. Maven + plugin development, Ant, Apache Commons, Spring security, Spring MVC, Tomcat,WSO2, xcmis, OpenCmis, Bonita, Python scripting, Unix shell remote scripting via ssh tunnels, PL/Python");
        workList.add(work);
        work = new WorkSection.Work("Luxoft (Deutsche Bank)");
        work.addDescription("12/2010 - 04/2012", "Ведущий программист", "Участие в проекте Deutsche Bank CRM (WebLogic, Hibernate, Spring, Spring MVC, SmartGWT, GWT, Jasper, Oracle). Реализация клиентской и серверной части CRM. Реализация RIA-приложения для администрирования, мониторинга и анализа результатов в области алгоритмического трейдинга. JPA, Spring, Spring-MVC, GWT, ExtGWT (GXT), Highstock, Commet, HTML5.");
        workList.add(work);
        work = new WorkSection.Work("Yota");
        work.addDescription("06/2008 - 12/2010", "Ведущий специалист", "Дизайн и имплементация Java EE фреймворка для отдела \"Платежные Системы\" (GlassFish v2.1, v3, OC4J, EJB3, JAX-WS RI 2.1, Servlet 2.4, JSP, JMX, JMS, Maven2). Реализация администрирования, статистики и мониторинга фреймворка. Разработка online JMX клиента (Python/ Jython, Django, ExtJS)");
        workList.add(work);
        work = new WorkSection.Work("Enkata");
        work.addDescription("03/2007 - 06/2008", "Разработчик ПО", "Реализация клиентской (Eclipse RCP) и серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) частей кластерного J2EE приложения (OLAP, Data mining).");
        workList.add(work);
        work = new WorkSection.Work("Siemens AG");
        work.addDescription("01/2005 - 02/2007", "Разработчик ПО", "Разработка информационной модели, проектирование интерфейсов, реализация и отладка ПО на мобильной IN платформе Siemens @vantage (Java, Unix).");
        workList.add(work);
        work = new WorkSection.Work("Alcatel");
        work.addDescription("09/1997 - 01/2005", "Инженер по аппаратному и программному тестированию", "Тестирование, отладка, внедрение ПО цифровой телефонной станции Alcatel 1000 S12 (CHILL, ASM).");
        workList.add(work);
        resume.addSection(SectionType.EXPERIENCE, workSection);
        workSection = new WorkSection();
        workList = workSection.getWorkList();
        work = new WorkSection.Work("Coursera");
        work.addDescription("03/2013 - 05/2013", "\"Functional Programming Principles in Scala\" by Martin Odersky", null);
        workList.add(work);
        work = new WorkSection.Work("Luxoft");
        work.addDescription("03/2011 - 04/2011", "Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\"", null);
        workList.add(work);
        work = new WorkSection.Work("Siemens AG");
        work.addDescription("01/2005 - 04/2005", "3 месяца обучения мобильным IN сетям (Берлин)", null);
        workList.add(work);
        work = new WorkSection.Work("Alcatel");
        work.addDescription("09/1997 - 03/1998", "6 месяцев обучения цифровым телефонным сетям (Москва)", null);
        workList.add(work);
        work = new WorkSection.Work("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики");
        work.addDescription("09/1993 - 07/1996", "Аспирантура (программист С, С++)", null);
        work.addDescription("09/1987 - 07/1993", "Инженер (программист Fortran, C)", null);
        workList.add(work);
        work = new WorkSection.Work("Заочная физико-техническая школа при МФТИ");
        work.addDescription("09/1984 - 06/1987", "Закончил с отличием", null);
        workList.add(work);
